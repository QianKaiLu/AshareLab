...
from media_factory.whisper_mlx import whisper_to_srt_long
...
if srt_path.exists():
    ...
    to_srt_prompt = name
    language = "zh"
    srt_path = whisper_to_srt_long(audio_path, output_dir=export_dir, language=language, prompt=to_srt_prompt)
    logger.info(f"✅ Transcription completed: {srt_path}")

# logger.info("🧠 Summarizing SRT content with AI...")
# mode: ModeType = "summary"
# extra_prompt = "这是一个英语语法教学视频，请基于这个前提来生成内容。"
