...
def ztalk_fig_v1(code: str, n: int = 60, width: int = 600, height: int = 600, theme_name: str = "vintage_ticker") -> go.Figure:
...
if __name__ == "__main__":
    fig = ztalk_fig_v1(code='600423', n=60, width=600, height=400, theme_name="vintage_ticker_pro")
    fig.show()